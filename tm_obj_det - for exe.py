...
def main():
    ...
    labels_path = f"{DIR_PATH}/teachable_machine_model/labels.txt"
    # open input file label.txt
    labelsfile = open(resource_path("labels.txt"), 'r')
    ...
    model_path = f"{DIR_PATH}/teachable_machine_model/keras_model.h5"
    model = tf.models.load_model(resource_path("keras_model.h5"), compile=False)
